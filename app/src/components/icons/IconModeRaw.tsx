...
// with the "M↓" glyph. Full-colour by design (Joe's art), not a currentColor
// line icon.
...
export function IconModeRaw({ size = 18, className = '' }: Props) {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        fill="#D2E1FF"
      />
      <path d="m80.8 12.7v13.9c0 2.1 1.5 4 3.6 4h14.5l-18.1-17.9z" fill="#668CED" />
      <path
