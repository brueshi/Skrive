...
const DEFAULT_APP_STATE =
    \\{"schemaVersion":1,"lastOpenedProject":null,"recentProjects":[],"license":null,"firstRunMs":null,"personalDictionary":[],"skipDeleteConfirmation":false,"recentFiles":[],"editorFont":"editorial","editorCustomFontFamily":"","editorFontSize":17,"editorLineHeightX100":170,"autoUpdateOnLaunch":true,"theme":"light","showOutlineRail":true,"defaultSurface":"rich","surfaceSwitchingEnabled":true,"markerMode":"recessed","lineMeasure":"normal","smartTypography":true,"formatOnSave":false,"autosaveIdleDelayMs":0,"newFileLocation":"activeFolder","newFileNaming":"title","slugFormat":"kebab-case","gitHistoryEnabled":true,"seedFrontmatter":true,"frontmatterFields":["title","date","tags"],"dateFormat":"YYYY-MM-DD"}
;
